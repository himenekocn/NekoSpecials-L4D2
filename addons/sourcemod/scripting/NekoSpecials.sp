...
public void OnPluginStart()
{
	...
	CSpecial_Boomer_Spawn_MinDis = 			AutoExecConfig_CreateConVar("Special_Boomer_Spawn_MinDis", "500", "Boomer刷新最小距离[范围不能小于1|仅梦魇和炼狱模式有效]", _, true, 1.0, false);
	CSpecial_Smoker_Spawn_MinDis = 			AutoExecConfig_CreateConVar("Special_Smoker_Spawn_MinDis", "500", "Smoker刷新最小距离[范围不能小于1|仅梦魇和炼狱模式有效]", _, true, 1.0, false);
	CSpecial_Charger_Spawn_MinDis = 		AutoExecConfig_CreateConVar("Special_Charger_Spawn_MinDis", "500", "Charger刷新最小距离[范围不能小于1|仅梦魇和炼狱模式有效]", _, true, 1.0, false);
	CSpecial_Hunter_Spawn_MinDis = 			AutoExecConfig_CreateConVar("Special_Hunter_Spawn_MinDis", "500", "Hunter刷新最小距离[范围不能小于1|仅梦魇和炼狱模式有效]", _, true, 1.0, false);
	CSpecial_Spitter_Spawn_MinDis = 		AutoExecConfig_CreateConVar("Special_Spitter_Spawn_MinDis", "500", "Spitter刷新最小距离[范围不能小于1|仅梦魇和炼狱模式有效]", _, true, 1.0, false);
	CSpecial_Jockey_Spawn_MinDis = 			AutoExecConfig_CreateConVar("Special_Jockey_Spawn_MinDis", "500", "Jockey刷新最小距离[范围不能小于1|仅梦魇和炼狱模式有效]", _, true, 1.0, false);

	CSpecial_Spawn_MaxDis = 				AutoExecConfig_CreateConVar("Special_Spawn_MaxDis", "1500", "全部特感刷新最大距离[范围不能小于1|仅引擎和普通模式有效]", _, true, 1.0, false);
	CSpecial_Spawn_MinDis = 				AutoExecConfig_CreateConVar("Special_Spawn_MinDis", "500", "全部特感刷新最小距离[范围不能小于1|仅引擎和普通模式有效]", _, true, 1.0, false);
