...
public Plugin myinfo =
{
	...
	description = "Neko Kill Status Hud Only Plugins Version!",
	author = "Neko Channel",
...
public void OnPluginStart()
{
	...
	NCvar[CKillHud_HudStyle] = 			AutoExecConfig_CreateConVar("KillHud_HudStyle", "2", "[0=关|1=样式1|2=样式2|3=自定义样式|4=聊天栏输出]Hud风格", _, true, 0.0, true, 4.0);
	...
	RegAdminCmd("sm_nhud", OpenHUDMenu, ADMFLAG_ROOT, "Neko HUD 菜单");
...
#include "nhud-plu/native.sp"
#include "nhud-plu/event.sp"
#include "nhud-plu/menu.sp"
#include "nhud-plu/main.sp"
#include "nhud-plu/tank.sp"

public APLRes AskPluginLoad2(Handle myself, bool late, char[] error, int err_max)
{
	RegPluginLibrary("nekokillhud");

	if(GetFeatureStatus(FeatureType_Native, "NekoKillHud_PlHandle") != FeatureStatus_Unknown)
	{
		strcopy(error, err_max, "\n==========\n已存在NekoKillHud，无需安装多个，请检查.\n==========");
